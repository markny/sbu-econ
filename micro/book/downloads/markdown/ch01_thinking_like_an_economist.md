...
chapter-number: 1
chapter-count: 20
description: "Economics helps explain how people choose, respond, and interact when they cannot have everything they want."
core-question: "How do economists explain choices, interactions, and unintended consequences when resources are scarce and rules or incentives change?"
key-tools: "Opportunity cost, marginal reasoning, incentives, models, and evidence"
opening-visual: "figures/ch01_marginal_benefit_cost.svg"
opening-visual-alt: "Marginal benefit and marginal cost curves meeting at the choice that maximizes net benefit."
opening-visual-caption: "Choices improve until the added benefit no longer exceeds the added cost."
---
...
The word *economics* traces to the Greek *oikonomia*. It joins *oikos*, commonly translated as household, with *nemein*, meaning management or distribution.[^leshem] The connection is natural. A household has limited time, labor, land, food, and other resources. It must decide how to use them for different purposes.
...
<div id="tbl:ch01-price-theory-reasoning">
...
::: {#fig:ch01-marginal-benefit-cost .econ-figure}
![The marginal-benefit curve slopes downward and the marginal-cost curve slopes upward, crossing at the chosen number of study hours.](../figures/ch01_thinking_like_an_economist/ch01_marginal_benefit_cost.svg)
...
::: aifiguredescription
**Figure description: `fig:ch01-marginal-benefit-cost`**

The horizontal axis is labeled "Hours of exam preparation," and the vertical axis is labeled "Benefit or cost of one additional hour." A solid downward-sloping curve labeled $MB$ represents the marginal benefit of another study hour. A solid upward-sloping curve labeled $MC$ represents the marginal cost of another study hour. The curves cross at an interior point. A guide from that crossing to the horizontal axis marks $H^*$, the chosen amount of preparation. To the left of $H^*$, the height of $MB$ exceeds the height of $MC$, so another hour raises total net benefit. To the right of $H^*$, $MC$ exceeds $MB$, so another hour lowers total net benefit and reducing study would improve the choice. At the crossing, the smooth model gives $MB = MC$ and total net benefit is maximized. The figure is a decision model, not measured student data. It does not imply identical curves, explicit calculation, perfect prediction of grades, or an exact interior equality when choices are indivisible or constrained.
:::
...
::: {#fig:ch01-incentive-change .econ-figure}
![A fee shifts the marginal-cost curve for checked bags upward and reduces the chosen number of checked bags.](../figures/ch01_thinking_like_an_economist/ch01_incentive_change_behavior.svg)
...
::: aifiguredescription
**Figure description: `fig:ch01-incentive-change`**

The horizontal axis is labeled "Checked bags per traveler," and the vertical axis is labeled "Benefit or cost of one additional bag." A solid downward-sloping curve labeled $MB$ represents the marginal benefit of checking another bag. Two upward-sloping marginal-cost curves are shown. The lower dashed curve, labeled $MC_0$, represents marginal cost before the fee. The higher solid curve, labeled $MC_1$, represents marginal cost after the per-bag fee. An upward arrow between the cost curves states that the fee raises marginal cost. The intersection of $MB$ with $MC_0$ is shown by an open marker and a dotted vertical guide to the initial choice $A_0$. The intersection of $MB$ with $MC_1$ is shown by a filled marker and a dashed vertical guide to the new choice $A_1$, which lies to the left, so $A_1 < A_0$. The economic conclusion is that raising the marginal cost of an activity reduces its chosen amount, other things equal. The figure predicts direction, not the size of the response. It is a stylized smooth representation of a discrete choice and does not establish whether the fee is desirable or whether checked-bag quantity is the only adjustment margin.
:::
...
1. What details did the model leave out?
2. What important idea does the model help us see?
3. What should happen if that idea is right?
4. What facts would make us more or less confident?
5. What else might explain what happened?
...
San Francisco's SFpark pilot provides a real example. Beginning in 2011, the city changed parking prices in selected areas according to location, time, and how crowded the spaces were. The goal was to make open spaces easier to find. The pilot also introduced new payment technology, longer time limits, real-time information about available spaces, and signs directing drivers to garages. Other areas did not receive the same package of changes.[^sfpark-program]
...
<div id="tbl:ch01-positive-normative">
...
Good economic reasoning looks beyond the first visible effect. In an 1850 essay, the French economist Frédéric Bastiat contrasted "what is seen" with "what is not seen."[^bastiat] His famous broken-window example begins after a shopkeeper's window is destroyed. Observers see work for the glazier who replaces it. What they do not see is what the shopkeeper would have purchased had the window remained intact.
...
1. What is limited?
2. What do people give up?
3. What price, rule, benefit, or cost changed?
4. How can people respond?
5. What rules shape their choices?
6. What else might happen after people respond?
7. What facts would help us check the explanation?
:::
...
1. Why can parking be costly when its posted money price is zero?
2. What is scarcity? How is it different from poverty and from a temporary shortage?
3. What is the difference between efficiency and equality? Why might public policy involve a trade-off between them?
4. Define opportunity cost. Why is it the value of the best alternative rather than the sum of all alternatives?
5. A student says the cost of college is tuition plus all room-and-board expenses. What important cost is missing, and why might the room-and-board estimate be too large?
6. What is full price? Give an example in which the money price stays constant while full price changes.
7. Why should a nonrefundable payment not determine the next action? Give an example.
8. What does rationality mean in this chapter? What does it not mean?
9. What do marginal benefit and marginal cost measure?
10. Why does increasing an activity while $MB > MC$ raise total net benefit?
11. What does $MB = MC$ mean? What does it not mean?
12. How should the marginal rule be applied when choices come only in whole units?
13. What is an incentive? Give one financial and one nonfinancial example.
14. Why is naming different ways people can respond more useful than saying only that “people respond”?
15. What does a model leave out, and how can leaving out details make the model useful?
16. Why is a comparison group often more informative than a before-and-after comparison alone?
17. Distinguish a positive statement from a normative statement using one policy example.
18. What is an unintended consequence? Must it be harmful?

## Economic Reasoning Questions

1. A university gives every student a free printing allowance. Long lines form near assignment deadlines. Explain what is limited, how students pay even when printing has no money price, how they can respond, and which rules matter.
2. You paid a nonrefundable registration fee for a weekend race, but you develop a fever the night before. Identify the sunk cost and the costs and benefits relevant to the decision you now face.
3. A professor replaces a large final exam with weekly quizzes. Identify at least three ways students might respond and one possible unintended consequence.
4. A streaming service raises its monthly subscription price but adds a cheaper plan with advertisements. Explain how the new choices might change what customers do.
5. A restaurant offers workers a bonus for serving more tables per hour. Predict an obvious response, a less visible change in service quality that may also occur, and facts that would help us learn the full effect.
6. A city reports that traffic fell after it introduced congestion pricing. Explain why a before-and-after comparison is incomplete and describe a more informative comparison.
7. Write one positive and one normative statement about charging for campus parking. Explain what evidence and values each statement requires.
8. Ask an AI system to explain how a new fee will change behavior. Evaluate its answer using the chapter's seven-question checklist. Identify one detail the answer assumed, one way people might respond that it missed, and one kind of evidence that would help check its explanation.

## Source Notes

[^leshem]: Dotan Leshem, "Retrospectives: What Did the Ancient Greeks Mean by Oikonomia?" *Journal of Economic Perspectives* 30, no. 1 (2016): 225-238, [https://doi.org/10.1257/jep.30.1.225](https://doi.org/10.1257/jep.30.1.225). Leshem supports the etymology and the limited comparison between ancient and modern thought while warning against treating them as identical.

[^sfpark-program]: San Francisco Municipal Transportation Agency, *SFpark Pilot Project Evaluation* (2014), [https://www.sfmta.com/sites/default/files/reports-and-documents/2018/08/sfpark_pilot_project_evaluation.pdf](https://www.sfmta.com/sites/default/files/reports-and-documents/2018/08/sfpark_pilot_project_evaluation.pdf). The agency's description documents the pilot and the additional technology, information, time-limit, and wayfinding changes bundled with demand-responsive pricing.
