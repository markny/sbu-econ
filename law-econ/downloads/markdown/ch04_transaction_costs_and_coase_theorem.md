...
::: figure fig:ch04-lake-factory-developer
![A factory with an initial right to discharge and a developer that values cleaner water are connected through a shared lake and a comparison of gains, control costs, and bargaining costs.](../figures/ch04_transaction_costs_and_coase_theorem/ch04_lake_factory_developer.svg)
...
::: aifiguredescription
**Figure description: `fig:ch04-lake-factory-developer`**

The diagram is a flow map rather than a statistical graph. Across the top, a box labeled Factory and initial right to discharge points through an arrow labeled discharge to a central box labeled Lake and shared resource. A second arrow labeled water quality points from the lake to a box labeled Developer and values cleaner water. Dashed arrows from the factory and developer lead to a comparison box asking whether the gains from cleaner water exceed pollution-control and bargaining costs. A yes branch leads to Agreement can fund controls. A no branch leads to Discharge continues or development changes. The main inference is that a clear legal entitlement establishes the no-agreement baseline, while the value of cleaner water, the cost of controls, and the cost of agreement determine whether a bargain can improve the joint outcome. The figure is schematic. It does not state the numerical bargaining range, determine which entitlement is fair, describe the law of a named jurisdiction, or claim that every pollution dispute involves only two parties.
:::
...
A legal entitlement is a legally recognized claim that establishes what a party may do or prevent before any bargain. Property rights are an important class of entitlements, but entitlements can also arise from nuisance law, regulation, permits, or contracts. The broader term lets us identify the legal starting position without implying that either party owns the entire resource in the ordinary sense.
:::
...
::: warning
**Reciprocal Harm Does Not Erase Responsibility**

Calling a conflict reciprocal does not deny physical harm, legal causation, fairness, or responsibility. It means that preventing one activity can also impose a cost. Economic analysis compares what each feasible arrangement requires society to give up.
:::
...
Cooperative surplus is the value created by agreement relative to the no-agreement outcome. It is the gains from agreement that the parties can potentially divide.
:::

Let $G$ represent the gain from cleaner water and $C$ represent the cost of pollution controls. Measured in millions of dollars, the cooperative surplus is:
...
<a id="tbl:ch04-cooperative-surplus-and-rights"></a>
...
::: keypoint
**Initial Rights Affect Distribution**

Even when costless bargaining produces the same efficient use, the initial legal entitlement affects the no-agreement baseline, who must obtain permission, who pays, and who receives the gains from agreement.
:::
...
When legal entitlements are clear and transferable and transaction costs are zero, private bargaining produces an efficient use of resources regardless of the initial assignment of the entitlement.
:::
...
::: warning
**The Coase Theorem Is Not A Claim That Law Does Not Matter**

The theorem identifies a world in which bargaining corrects the resource-use consequences of the initial entitlement. Law still determines the bargaining baseline and distribution. In the real world, positive transaction costs make legal rules even more consequential.
:::
...
Transaction costs are the costs of arranging and carrying out exchange. They include finding parties and relevant information, negotiating and recording agreement, and monitoring and enforcing performance.
:::
...
A holdout tries to capture more of the gains from agreement by withholding necessary cooperation. A free rider tries to receive the benefit of collective action without paying a share of its cost. Either problem can block an agreement that would create value.
:::
...
These costs can be compared with the cooperative surplus. Let $T$ represent total transaction costs, measured in millions. The net gains potentially available from the bargain are:
...
Positive transaction costs determine which agreements are feasible. Legal rules affect who must coordinate, what information is available, who has leverage, and what happens when agreement fails.
:::
...
::: quickconcept
**Normative Coase and Normative Hobbes**

The Normative Coase principle says law should reduce impediments to private agreement when bargaining can work. The Normative Hobbes principle says law should reduce the harm caused by bargaining failure when agreement is unlikely.
:::
...
<a id="tbl:ch04-institutional-responses"></a>
...
1. Why does the factory-lake-developer conflict initially appear to be a standard negative externality?
2. What is the basic Pigouvian response to an external cost?
3. What does reciprocal harm mean?
...
11. Why is zero transaction cost a benchmark rather than a realistic description?
12. How can the initial entitlement affect distribution even when it does not affect efficient resource use?
13. Distinguish search, bargaining, and enforcement costs.
14. Distinguish a holdout from a free rider.
15. What does the Normative Coase principle recommend?
16. What does the Normative Hobbes principle recommend?
17. What is the least-cost-avoider question?
18. Why should institutional responses be compared by their information and enforcement requirements?
19. Why might a law-and-economics analysis use the term legal entitlement rather than property right when describing the starting position in a dispute?
...
1. Describe the conflict neutrally. Identify each valuable use and separate physical causation from the economic comparison.
2. Identify the current or assumed legal entitlement and the no-agreement outcome. If using a real dispute, verify the entitlement against an authoritative source and state the jurisdiction and date.
3. Estimate or construct plausible values for the benefit of changing the use, the cost of adjustment, and any direct implementation cost. Clearly label hypothetical numbers.
4. Calculate the cooperative surplus, if any, relative to the no-agreement baseline. Identify the gross bargaining range without predicting a unique payment.
5. Reverse the entitlement. Determine what changes in resource use, payment, leverage, and distribution under zero transaction costs.
6. Use an AI system to generate a list of possible transaction costs and strategic problems. Classify each as a search or information cost, bargaining cost, or monitoring and enforcement cost.
7. Critique the AI response. Remove generic items that do not fit the facts, identify at least one omitted obstacle, and correct any unsupported legal claim.
8. Compare at least three institutional responses, such as private bargaining, an injunction, damages, a tax or fine, a direct rule, association governance, or organizational integration.
9. Apply the Normative Coase and Normative Hobbes principles. Explain which obstacles law could reduce and what no-agreement rule would limit the harm if bargaining fails.
10. Conclude with a recommendation and a confidence statement. Identify the missing information most likely to change your conclusion.
