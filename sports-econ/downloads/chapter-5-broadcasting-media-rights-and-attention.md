# Broadcasting, Media Rights, and the Battle for Attention
...
Complaints about NFL holiday games require one factual distinction. The traditional Thanksgiving Day tripleheader remains available through major broadcast networks. The newer fragmentation appears around that centerpiece. In 2026, the NFL added its first Thanksgiving Eve game, Packers–Rams, on Netflix. Netflix's expanded package through 2029 includes five regular-season games each year: one in Week 1, Thanksgiving Eve, two on Christmas Day, and one late-season Saturday game. For Christmas 2026, Packers–Bears and Bills–Broncos are scheduled for Netflix, while Rams–Seahawks remains on Fox.[^nfl-holiday-streaming] Recent postseasons have also placed one wild-card game on a streaming platform.[^sports-streaming-policy]

For most of the country, watching every attractive game can therefore require some combination of broadcast television, cable channels, Prime Video, Netflix, Peacock, NFL Network, and other services. Streaming-exclusive games are generally still offered free over the air in the participating teams' home television markets, but that exception does not cover every fan in the team's state or region. A game available nationally to anyone willing and able to subscribe is not a traditional geographic **blackout**. It is better described as an exclusive paywalled package. The distinction matters even when both arrangements frustrate viewers.

The NFL and a streaming platform have an economic reason to prefer exclusivity. A game that cannot be seen elsewhere can attract new subscribers, reduce cancellations, sell advertising, and differentiate the service from its rivals. Those benefits raise the platform's willingness to pay for the rights. For a fan, however, the cost is larger than the posted price of one subscription. It can include finding the game, creating and canceling accounts, learning new interfaces, obtaining suitable equipment and broadband, and paying for a service that the household may not otherwise want. A household that already buys Netflix faces a different incremental cost than one subscribing for a single Bills game.
...
::: warning
**Ratings, Viewers, Reach, Subscribers, And Minutes Are Not Interchangeable**

A rating is a percentage of a defined population. Average viewers estimate how many people were watching during an average minute. Reach counts people who encountered content at least once under a stated rule. Subscribers count accounts or households with access, whether or not they watched. Viewing minutes measure time consumed. Each can answer a useful question, but a table that ranks a rating, an average audience, a subscriber count, and total minutes as if they were the same quantity is not evidence.
:::
...
A league or team controls the right to show a game. A broadcaster or streaming platform licenses some of those rights, produces and distributes the telecast, attracts viewers or subscribers, and sells access to advertisers or households. Distributors, device platforms, local affiliates, and production partners may perform additional functions. Money flows toward the rights holder; games, access, and audience attention flow through the system.
:::
...
::: quickconcept
**A Two-Sided Platform Is Not The Same As The Rights Market**

A two-sided platform serves groups whose participation affects one another. In sports media, viewers attract advertisers and advertising revenue can help finance content for viewers. The separate upstream transaction is the platform's purchase or license of rights from a league or team. Calling the entire chain “two-sided” can hide who owns the rights and where bargaining occurs.
:::
...
Bundling sells access to several products as a package. A la carte pricing lets consumers select and pay for individual products. A bundle can spread fixed content costs across a large customer base, but it also requires households to pay for channels they may rarely or never watch.
:::
...
::: sideline
**ESPN's Subscriber Floor**

Analysts sometimes ask whether ESPN has a “subscriber floor”—a level below which the shrinking traditional bundle can no longer support its rights and other costs. The phrase is useful if it is treated as a scenario, not as a number we can read directly from public filings.

The floor depends on more than the count of linear subscribers. It also depends on effective carriage rates, advertising revenue, direct subscriptions, churn, production expense, rights commitments, the contribution of other ESPN products, and the strategic value ESPN creates elsewhere in Disney's distribution system. A household that moves from cable to a direct ESPN service does not merely switch columns in a spreadsheet. The retail price, acquisition cost, billing relationship, cancellation behavior, advertising opportunity, and package of content may all change.

Disney launched its ESPN direct service in August 2025. That step increased its ability to reach households outside the traditional bundle and to manage a direct customer relationship. It also made ESPN more responsible for attracting, retaining, billing, and serving those customers.[^disney-2025]

The economically useful question is therefore not, “How many direct subscribers replace one cable subscriber?” The useful questions are:

1. How much contribution does each type of customer generate after the relevant costs?
2. How long does the customer remain?
3. What advertising and promotional value accompanies the subscription?
4. How does direct access affect the price and attractiveness of the remaining bundle?
5. Who bears the risk if the audience is smaller than expected?

A published break-even number that omits these terms creates false precision. The floor is a decision problem, not a constant.
:::

::: casestudy
**ESPN From Bundle Anchor To Direct Distribution**

ESPN's experience brings the chapter's mechanisms together. Linear reach fell substantially, but the financial effect was partly offset by higher effective rates. Advertising remained a second major source of revenue. Direct distribution then opened another route to viewers while shifting more responsibility for acquisition, billing, retention, and demand risk toward ESPN.

ESPN also became an aggregator as well as a distributor. In January 2026, ESPN closed its acquisition of NFL Network, NFL Fantasy, and specified NFL RedZone distribution rights in exchange for a 10 percent NFL equity stake in ESPN. The NFL retained other media operations and digital RedZone rights, a reminder that a transaction can combine ownership, licensing, and retained rights rather than transfer an entire media business. Under MLB's 2026–28 national agreements, ESPN also received a midweek game package and the right to sell MLB.TV, MLB's out-of-market service.[^espn-aggregation]

These moves place more sports inventory and customer access inside ESPN's system. That can make the direct service more attractive, create cross-promotion, and reduce cancellations. It can also increase organizational complexity and exposure to rights and operating costs.

The case is not a simple story of an old product being replaced by a new app. ESPN is managing several connected products and relationships at once. The strategic problem is how to preserve broad reach, finance expensive rights, serve households outside the traditional bundle, and avoid making access so fragmented or costly that future demand weakens.
:::
...
::: sideline
**What Does A Network Or Streamer Actually Add?**

A fan who already knows she wants to watch the Bills does not need a network to discover the Bills. That does not make the network useless. A media partner may add:

- a guaranteed payment that transfers audience and advertising risk away from the league
- production quality and technical reliability at national scale
- a large installed audience and simple access
- advertising sales and relationships with national buyers
- promotion across news, entertainment, and other sports
- billing, customer service, identity management, and device distribution
- a bundle that lowers customer-acquisition cost or reduces churn
- credibility with casual viewers who are less committed than the core fan

The league should compare the value and cost of these services with what it could build or buy itself. “Go direct” is a choice about vertical integration and contracting, not a way to make the functions vanish.
:::
...
::: warning
**A Smaller Number Of Subscriptions Is Not Automatically A Lower Price**

The price of access depends on which rights are included, who else contributes to fixed costs, how much advertising the service carries, and how strongly the selected customers value the content. A large bundle can be expensive while making sports cheap at the margin to the household. A narrow sports service can offer greater choice while charging an enthusiast a high visible price. Count the content, payment base, and access rules—not only the number of apps.
:::
...
1. How many existing and potential fans can access the games?
2. What guaranteed and contingent revenue does the proposal create?
3. How much promotional support will the partner provide?
4. How will access affect attendance, sponsorship, merchandise, and long-run fandom?
5. Which party bears production, technology, advertising, and demand risk?
6. Does exclusivity make the product more valuable or make the sport too difficult to find?
...
::: sideline
**The Dodgers' Television Deal: An Advantage, Not A Complete Explanation**

The Los Angeles Dodgers provide a more complicated example. During the club's 2011 bankruptcy, the Dodgers and Major League Baseball reached a court-approved settlement that allowed the team and its media rights to be sold. The accompanying media terms used a benchmark for the local television revenue subject to MLB's revenue-sharing assessment. The initial benchmark was about $84 million in the first year with a 4 percent annual increase. When the new owners later completed a reported 25-year, $8.35 billion agreement with Time Warner Cable, MLB and the Dodgers negotiated a higher first-year benchmark of roughly $130 million—but still did not simply treat the entire headline value of the agreement as annual team revenue for revenue-sharing purposes.[^dodgers-media]
...
::: casestudy
**The Regional-Sports-Network Reckoning**

Major League Baseball's local-media operations show how a rights holder can respond when the old regional model no longer provides stable distribution. In 2025, MLB produced and distributed local telecasts for five clubs and offered in-market direct streaming without local blackouts for those club broadcasts, subject to national exclusivities. By the 2026 season, MLB reported that it was producing and distributing local games for fourteen clubs through a combination of in-market streaming and cable, satellite, telephone-company, and virtual distributors.[^mlb-local-media]

This is not a simple switch from an RSN to an app. MLB took on or arranged production, negotiated with distributors, sold local advertising, operated streaming access, and helped fans locate the games. The league assumed functions and risks that had previously been bundled inside a regional network agreement.

The change can increase potential reach. For Cleveland's 2025 transition, the Guardians reported that the prior regional network reached about 1.45 million households, while the new distribution options could reach approximately 4.86 million. Those are potential household footprints rather than measured viewers, and the larger reach does not by itself reveal whether the new model generated more revenue.[^guardians-local]

The case exposes four separate questions:

1. **Access:** Can local fans actually receive the games?
2. **Revenue:** Do subscriptions, advertising, and distributor payments replace the old guarantee?
3. **Risk:** Does the team, league, or media company bear the loss if demand disappoints?
4. **Control:** Who sets prices, manages customer data, sells advertising, and produces the telecast?

A policy that removes a local blackout can improve access without eliminating every national exclusivity. A larger potential footprint can benefit sponsorship and long-run fandom while still producing less short-run cash than a generous RSN contract. The model should therefore be judged against the realistic alternative, not against a system that simultaneously guarantees maximum revenue, universal access, and zero risk.
:::
...
The English Premier League shows that distribution is shaped by institutions as well as technology. For the 2025–26 through 2028–29 seasons, the league's UK live packages are held by Sky Sports and TNT Sports, with BBC Sport holding free-to-air highlights. The agreements make every match outside the Saturday 3 p.m. closed period available for live UK broadcast, but games played during that protected window are not shown live domestically.[^premierleague-uk]

In the United States, NBC's agreement through 2028 covers all 380 matches each season across its platforms.[^premierleague-us] The same competition therefore creates different access products in different territories.
...
In a common-value auction, the winner may be the bidder that most overestimated the uncertain value of the asset. A rational bidder should ask not only, “What do I estimate the rights are worth?” but also, “What does winning imply about the estimates made by the bidders I defeated?”
:::

The winner's curse does not mean the winner literally regrets every auction or that the highest bid is automatically foolish. It is a warning about selection. Conditional on winning, a bidder's estimate is more likely to have been unusually optimistic. Experienced bidders can respond by reducing their bids, improving information, sharing risk, or writing contingent terms.[^kagel-levin]
...
::: warning
**A Reported Rights Value Is Not Automatically An Official Contract Figure**

Media agreements often contain options, production obligations, equity arrangements, sublicensing, international rights, or payments allocated across several properties. A news report may state an estimated total value even when the league has not disclosed one. Label the number as official, reported, or estimated; identify the term and territory; and do not divide a headline value into a precise annual price unless the contract structure supports that calculation.
:::
...
A league is choosing between a guaranteed exclusive agreement and a league-run service with uncertain subscriptions.

Before recommending either proposal, ask an AI tutor to help you create a decision table with these categories: guaranteed revenue, expected upside, production cost, customer-acquisition cost, advertising, reach, exclusivity, data, churn, fan access, complementary sales, and risk.

Then do three things:

1. Identify which entries are facts, which are forecasts, and which are strategic judgments.
2. Construct a strong case for each proposal.
3. State the three pieces of missing information most likely to change your recommendation.

Do not let the AI choose for you until you have defined the objective and the counterfactual.
:::
...
$$
V = \sum_{t=1}^{T}\frac{E(CF_t)}{(1+r)^t},
$$

where $V$ is the asset's value, $E(CF_t)$ is expected cash flow in future period $t$, and $r$ reflects the time value of money and risk.
...
1. More entertainment choices disperse ordinary audiences.
2. A live sports schedule can coordinate a large audience before the outcome is known.
3. That scarce simultaneous attention is valuable to advertisers, subscription platforms, and larger business ecosystems.
4. Leagues and teams create the contest and control rights, but production, distribution, promotion, billing, and risk bearing still must occur.
5. The cable bundle spread fixed rights costs across a very broad household base.
6. Cord-cutting shrinks that base and shifts the business toward higher rates, direct subscriptions, mixed distribution, and new bundles.
7. Package design trades off exclusivity, reach, current revenue, fan access, promotion, and long-run demand.
8. Competitive bidding can transfer value to leagues, but uncertain common value creates winner's-curse risk.
9. National and local rights allocate revenue and risk differently across teams.
10. Expected future media distributions can be capitalized into franchise value.
...
1. Distinguish media fragmentation, audience fragmentation, and sports-distribution fragmentation.
2. Why does an increase in entertainment fragmentation potentially make a large NFL audience more valuable?
3. What features of live sports encourage viewers to watch simultaneously?
4. Why is a large average audience not the same as reach? Why do advertisers care about the distinction?
5. Identify the upstream rights transaction and the downstream sides of a sports-media platform.
6. How did the cable bundle spread the fixed costs of sports rights across households?
7. Why does a decline in channel subscribers not imply an equal percentage decline in revenue?
8. What new risks does a league bear when it moves toward direct distribution?
9. Why can unbundling eventually lead to re-bundling?
10. What does a network or streaming platform add if fans already know which team they want to watch?
11. Why can streaming exclusivity increase a platform's willingness to pay while also increasing fans' access costs?
12. How do national and local media rights differ?
13. Why can broader potential reach fail to produce more short-run revenue?
14. How can team ownership of part of an RSN change both the potential return and the risk from local media rights?
15. Explain the winner's curse in a common-value auction.
16. Why might two rational platforms place different values on the same rights package?
17. How can expected media revenue affect franchise value without producing a fixed revenue multiple?
...
2. A sports channel loses 8 percent of its subscribers while its effective revenue per remaining subscriber rises 6 percent. Without using the numbers as a claim about any real company, approximate the direction of subscription revenue. Why would advertising and cost information still be needed to assess profit?
3. A league receives two proposals. Partner A guarantees \$1.2 billion and places every game behind one exclusive subscription. Partner B guarantees \$900 million, places half the games on broadcast television, shares direct-subscription revenue on the rest, and promises \$100 million in promotion. List the additional information needed before deciding. Explain who bears more audience risk under each proposal.
4. Three bidders estimate that the common revenue value of a package is \$800 million, \$900 million, and \$1.1 billion. Each has no special complementary use for the rights. Why should the \$1.1 billion bidder worry about the winner's curse? How would the analysis change if that bidder could also use the games to reduce cancellations in another profitable service?
5. A team moves from an RSN agreement to league-produced telecasts available through local streaming and several distributors. Construct a table showing what may happen to reach, guaranteed revenue, customer data, production responsibility, and demand risk. Which changes are theoretically ambiguous?
6. An article claims that a sports property is “more popular” because it generated more total viewing minutes than another property generated average viewers. Explain why the comparison is invalid and describe one defensible comparison.
7. Suppose a new national media agreement raises each team's expected annual cash flow by \$20 million for ten years. Explain why the effect on franchise value depends on the discount rate, risk, costs, and expectations after year ten. No calculation is required.

::: studyandlearn
**Audit A Sports-Media Claim**

Choose a current statement about a league's audience, rights value, or streaming reach. Record the date and original source. Then answer:

1. What exactly is measured: rating, average viewers, reach, subscribers, accounts, or minutes?
2. What population, territory, platforms, and period are included?
3. Is the number official, reported, or estimated?
4. Did the measurement method change?
5. Does the evidence describe an association, a forecast, or a causal effect?
6. What is the strongest conclusion the evidence supports?
7. What tempting conclusion goes beyond the evidence?

Ask an AI tutor to challenge your answers, but require it to quote your definitions of the measures before evaluating the claim.
:::
